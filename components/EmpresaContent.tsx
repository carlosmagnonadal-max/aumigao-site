...
const plans = [
  ...
  },
  {
    ...
    feats: [
      ...
      "Vitrine de destaques e promoções no app do tutor — exclusivo Enterprise",
      "Avaliação multi-equipe no perfil do pet (creche, banho e tosa, adestramento) — exclusivo Enterprise",
