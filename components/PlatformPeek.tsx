...
const content = {
  ...
  passeador: { cap: <>O app do <em>passeador</em>: o Walk.</>, lead: "A rede de passeadores é da Aumigão, dentro do app Walk. Você entra uma vez (com o seu aceite) e, credenciado, atende várias empresas pet parceiras — um único cadastro, mais demanda e mais oportunidade. Ganhos claros e reputação que valoriza quem cuida.", bullets: ["Atende várias empresas pet com um só cadastro", "Ganhos transparentes e saque fácil", "Agenda própria e matching por região", "Kit, credenciamento e suporte"], link: "#baixar", linkLabel: "Baixar o Walk e ser passeador" },
