      ...
      <div className="mx-auto max-w-7xl">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 text-3xl font-black text-brand-ink md:text-4xl">
            Mais confianca para cada ponta da operacao.
          </h2>
        </div>
        <div className="mt-10 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {benefits.map((benefit) => (
            <article
              key={benefit.title}
              className="rounded border border-black/5 bg-white p-6 shadow-soft"
            >
              <div className="mb-6 h-10 w-10 rounded bg-brand-mint" />
