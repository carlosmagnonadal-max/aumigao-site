    ...
    >
      <article className={s.legal}>
        ...
        <div className={s.sec}>
          <h2>1. Definições</h2>
          <ul>
            <li><strong>Plataforma / Aumigão Walk:</strong> o conjunto de aplicativos, site institucional, painéis administrativos e serviços de tecnologia desenvolvidos e operados pela Aumigão Walk Tecnologia, que conectam tutores a passeadores de cães.</li>
            ...
            <li><strong>Operadora:</strong> Aumigão Walk Tecnologia (Carlos Magno Nadal Sant&apos;Ana Sobrinho LTDA), operadora da Plataforma.</li>
          </ul>
        </div>
        ...
        <div className={s.sec}>
          ...
          <ul>
            ...
            <li>As credenciais de acesso (e-mail e senha) são pessoais e intransferíveis. O Usuário é o único responsável pela confidencialidade de sua senha e por todas as ações realizadas em sua conta. Em caso de uso não autorizado, comunicar imediatamente a Aumigão Walk Tecnologia pelo e-mail contato@aumigaowalk.com.br.</li>
          </ul>
          <p>A Aumigão Walk Tecnologia poderá suspender ou encerrar a conta de Usuário que fornecer informações falsas, incompletas ou desatualizadas, sem prejuízo das medidas legais cabíveis.</p>
        </div>
        ...
        <div className={s.sec}>
          ...
          <ul>
            ...
            <li>Utilizar meios automatizados (bots, scrapers, crawlers) para acessar ou coletar dados da Plataforma sem autorização expressa da Aumigão Walk Tecnologia.</li>
        ...
        <div className={s.sec}>
          ...
          <p>Ao inserir Conteúdo do Usuário na Plataforma, o Usuário concede à Aumigão Walk Tecnologia licença não exclusiva, gratuita, transferível e sublicenciável para exibir, reproduzir e utilizar esse conteúdo exclusivamente no contexto da operação da Plataforma e de suas comunicações institucionais, pelo prazo de vigência destes Termos.</p>
          <p>A Aumigão Walk Tecnologia reserva-se o direito de remover, sem aviso prévio, Conteúdo do Usuário que viole estes Termos, a legislação aplicável ou os padrões de comunidade da Plataforma.</p>
        </div>

        <div className={s.sec}>
          <h2>7. Propriedade intelectual</h2>
          <p>A marca Aumigão Walk, os logotipos, o software, o design, as interfaces, os textos e os demais elementos da Plataforma são de titularidade da Aumigão Walk Tecnologia ou licenciados a ela, e estão protegidos pela legislação brasileira de propriedade intelectual. É vedada a cópia, reprodução, modificação, distribuição ou utilização desses elementos sem autorização prévia e expressa da Aumigão Walk Tecnologia.</p>
        ...
        <div className={s.sec}>
          ...
          <p>A Aumigão Walk Tecnologia poderá suspender ou encerrar a conta de qualquer Usuário, com ou sem aviso prévio, nos seguintes casos: (i) violação destes Termos ou do Termo Específico aplicável; (ii) conduta que coloque em risco a segurança de pessoas, animais ou da Plataforma; (iii) fornecimento de informações falsas; (iv) prática de atos fraudulentos ou ilícitos; (v) inatividade prolongada da conta.</p>
          <p>O Usuário pode encerrar sua conta a qualquer momento, pelo aplicativo ou por solicitação ao e-mail contato@aumigaowalk.com.br. O encerramento não afeta obrigações já constituídas nem o tratamento de dados que a Aumigão Walk Tecnologia deva manter por obrigação legal.</p>
        ...
        <div className={s.sec}>
          ...
          <p>Operadora: Aumigão Walk Tecnologia (Carlos Magno Nadal Sant&apos;Ana Sobrinho LTDA) — CNPJ 67.562.337/0001-63 — Av. Tancredo Neves, nº 1485, Edif. Esplanada Trade Center, Caixa Postal 9133, Caminho das Árvores, Salvador/BA, CEP 41.820-021.</p>
        </div>
      </article>
