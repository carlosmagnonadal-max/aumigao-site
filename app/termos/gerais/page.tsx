    ...
    <section className="ov-section ov-center ov-grain">
      ...
      <div className="ov-wrap">
        <div className="ov-section-head ov-section-center">
          ...
          <h1 className="ov-ptitle">Termos Gerais da Plataforma</h1>
          <p className="ov-lead">
            Regras gerais aplicáveis a todos os usuários da Plataforma. Cada
            perfil de usuário está sujeito adicionalmente ao seu Termo
            Específico.
          </p>
        </div>
        ...
        <div className="ov-cta-row" style={{ justifyContent: "center", marginTop: 40 }}>
          ...
          <Link href="/privacidade" className="ov-btn ov-btn-primary">
            Política de Privacidade <span className="ov-arr">→</span>
          </Link>
        </div>
      </div>
    </section>
