    ...
    >
      <article className={s.legal}>
        <div className={s.sec}>
          ...
          <p>
            ℹ <strong>Leia antes de aceitar.</strong> As cláusulas que limitam direitos ou estabelecem obrigações relevantes estão sinalizadas com{" "}
        ...
        <div className={s.sec}>
          ...
          <p>
            <strong>[ ] LI E ACEITO OS TERMOS DE TRATAMENTO DOS MEUS DADOS PESSOAIS</strong>
          </p>
        </div>
