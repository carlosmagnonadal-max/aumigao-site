...
export default function TermosWhiteLabelPage() {
  return (
    <InnerPage
      narrow
      eyebrow="Termos"
      title="Contrato de Licença White Label"
      lead={
        <>
          Contrato B2B entre a Aumigão Walk Tecnologia e a Empresa Parceira para operação da
    ...
    >
      <article className={s.legal}>
        <div className={s.sec}>
          <p className={s.meta}>
            <strong>Licenciante:</strong> Aumigão Walk Tecnologia (Carlos Magno Nadal Sant&apos;Ana Sobrinho LTDA) &nbsp;·&nbsp;
            <strong>CNPJ:</strong> 67.562.337/0001-63 &nbsp;·&nbsp;
            <strong>Última atualização:</strong> 11 de junho de 2026
          </p>
          <p>
            ℹ <strong>Natureza do documento:</strong> Contrato B2B (empresa para empresa) regido pelo Código Civil e legislação empresarial brasileira. As cláusulas que estabelecem responsabilidades operacionais, SLA, dados e rescisão estão sinalizadas com{" "}
        ...
        <div className={s.sec}>
          <h2>1. Definições</h2>
          <ul>
            <li><strong>Licenciante / Aumigão Walk Tecnologia:</strong> Aumigão Walk Tecnologia Intermediação e Agenciamento de Serviços e Negócios Ltda., operadora da infraestrutura Aumigão Walk.</li>
            ...
            <li><strong>Passeadores da Operação:</strong> os prestadores de serviço independentes cadastrados, verificados e aprovados pela Empresa Parceira (ou pela Aumigão Walk Tecnologia, conforme acordado) para operar na Operação da Empresa Parceira.</li>
            <li><strong>Tutores da Operação:</strong> os usuários finais (donos de pets) cadastrados na Operação da Empresa Parceira.</li>
            <li><strong>Painel Administrativo:</strong> a interface de gestão fornecida pela Aumigão Walk Tecnologia à Empresa Parceira para configuração, monitoramento e operação da sua instância da Plataforma.</li>
          </ul>
        </div>

        <div className={s.sec}>
          <h2>2. Objeto do contrato</h2>
          <p>A Aumigão Walk Tecnologia concede à Empresa Parceira <strong>licença de uso não exclusiva, intransferível e por prazo determinado</strong> da infraestrutura tecnológica da Plataforma Aumigão Walk, para que a Empresa Parceira opere, sob sua própria marca, um serviço de intermediação de passeios de cães em seu território de atuação, nos termos e condições deste Contrato.</p>
          <p>A licença inclui: (i) acesso e uso dos aplicativos Tutor e Passeador customizados com a Marca da Empresa Parceira; (ii) acesso ao Painel Administrativo; (iii) uso da infraestrutura de backend, matching, pagamentos e notificações; (iv) suporte técnico nos termos da Cláusula 5; (v) atualizações da Plataforma disponibilizadas pela Aumigão Walk Tecnologia durante a vigência.</p>
        </div>

        <div className={s.sec}>
          <h2>3. Configuração e personalização</h2>
          <h3>3.1. Identidade visual</h3>
          <p>A Aumigão Walk Tecnologia disponibiliza à Empresa Parceira ferramentas para configuração da identidade visual da Operação: nome da marca, logotipo, paleta de cores primária e demais parâmetros disponíveis na versão vigente da Plataforma.</p>
          ...
          <p>A personalização é limitada às funcionalidades disponíveis na Plataforma. Desenvolvimentos customizados além do escopo padrão são objeto de negociação separada entre as partes. A Empresa Parceira não pode: (i) remover ou ocultar atribuições legais obrigatórias; (ii) modificar o código-fonte da Plataforma; (iii) integrar sistemas de terceiros sem aprovação prévia da Aumigão Walk Tecnologia.</p>
        </div>

        <div className={s.sec}>
          <h2>4. Obrigações da Aumigão Walk Tecnologia (Licenciante)</h2>
          <p>A Aumigão Walk Tecnologia obriga-se a:</p>
          <ul>
        ...
        <div className={s.sec}>
          ...
          <p>Em caso de disponibilidade inferior ao mínimo garantido (excluídas as exceções da Cláusula 5.1), a Empresa Parceira terá direito a desconto proporcional na mensalidade do período afetado, calculado com base nas horas de indisponibilidade que excedam o limite tolerado. O desconto é o único remédio disponível para descumprimento do SLA, salvo dolo ou culpa grave da Aumigão Walk Tecnologia.</p>
          ...
          <p>A responsabilidade da Aumigão Walk Tecnologia por danos decorrentes de indisponibilidade da Plataforma está limitada ao valor da mensalidade do período afetado, exceto em casos de dolo ou culpa grave. A Aumigão Walk Tecnologia não responde por lucros cessantes ou perda de receita operacional da Empresa Parceira decorrentes de indisponibilidade.</p>

          <p>
            <strong>[ ] LI E ACEITO OS TERMOS DE DISPONIBILIDADE E SLA, INCLUINDO A LIMITAÇÃO DE RESPONSABILIDADE POR INDISPONIBILIDADE</strong>
          </p>
        </div>
        ...
        <div className={s.sec}>
          ...
          <ul>
            ...
            <li>Informar e cumprir os Termos do Tutor e os Termos do Passeador da Plataforma junto aos seus usuários finais, podendo adaptá-los com autorização da Aumigão Walk Tecnologia.</li>
            ...
            <li>Comunicar à Aumigão Walk Tecnologia, no prazo de 48 horas, qualquer incidente operacional grave (acidente com animal, reclamação judicial, investigação de autoridade) que envolva a Operação.</li>
          </ul>
        </div>
        ...
        <div className={s.sec}>
          ...
          <h3>7.4. Indenidade da Aumigão Walk Tecnologia</h3>
          <p>A Empresa Parceira obriga-se a manter a Aumigão Walk Tecnologia livre e indene de reclamações, demandas e condenações originadas em falhas ou irregularidades na condução de sua Operação local que não sejam atribuíveis à infraestrutura tecnológica da Aumigão Walk Tecnologia.</p>

          <p>
            <strong>[ ] LI E ACEITO AS RESPONSABILIDADES OPERACIONAIS DA EMPRESA PARCEIRA, INCLUINDO A OBRIGAÇÃO DE INDENIDADE DA Aumigão Walk Tecnologia</strong>
          </p>
        </div>
        ...
        <div className={s.sec}>
          ...
          <ul>
            <li>A <strong>Aumigão Walk Tecnologia</strong> atua como <strong>controladora</strong> dos dados pessoais tratados na infraestrutura da Plataforma (cadastro, KYC, transações, logs de sistema) e como <strong>operadora</strong> em relação aos dados configurados e geridos exclusivamente pela Empresa Parceira via Painel Administrativo.</li>
            <li>A <strong>Empresa Parceira</strong> atua como <strong>controladora</strong> dos dados pessoais dos Tutores e Passeadores de sua Operação para as finalidades de sua atividade comercial local, e como <strong>operadora</strong> em relação aos dados processados pela infraestrutura da Aumigão Walk Tecnologia.</li>
          </ul>
          ...
          <h3>8.5. Auditoria</h3>
          <p>A Aumigão Walk Tecnologia fornecerá à Empresa Parceira, mediante solicitação fundamentada, informações sobre as medidas de segurança adotadas e os incidentes de segurança ocorridos, no prazo de 15 (quinze) dias úteis.</p>

          <p>
            <strong>[ ] LI E ACEITO AS OBRIGAÇÕES DE TRATAMENTO DE DADOS PESSOAIS E CO-RESPONSABILIDADE LGPD NO ÂMBITO DA MINHA OPERAÇÃO</strong>
          </p>
        </div>
        ...
        <div className={s.sec}>
          ...
          <p>A remuneração devida pela Empresa Parceira à Aumigão Walk Tecnologia é definida na proposta comercial aceita pelas partes e pode compreender: (i) mensalidade fixa de licença; (ii) percentual sobre o volume transacionado na Operação; ou (iii) combinação de ambos. Os valores são reajustados anualmente pelo IPCA, salvo acordo diverso.</p>
        ...
        <div className={s.sec}>
          ...
          <p><em>Pela Aumigão Walk Tecnologia:</em> (i) inadimplência da Empresa Parceira por mais de 30 (trinta) dias após notificação; (ii) uso da Plataforma para fins ilícitos ou que violem direitos de terceiros; (iii) violação grave das obrigações de proteção de dados; (iv) conduta que cause dano à reputação da Aumigão Walk Tecnologia ou da Plataforma.</p>
          <p><em>Pela Empresa Parceira:</em> (i) violação grave pela Aumigão Walk Tecnologia das obrigações de disponibilidade (SLA) não resolvida em 30 dias após notificação formal; (ii) alteração unilateral e substancial das condições deste Contrato pela Aumigão Walk Tecnologia sem aceite da Empresa Parceira.</p>
          ...
          <p>
            <strong>[ ] LI E ACEITO AS CONDIÇÕES DE RESCISÃO DO CONTRATO, INCLUINDO OS EFEITOS SOBRE O ACESSO À PLATAFORMA E AOS DADOS DA OPERAÇÃO</strong>
          </p>
        </div>

        <div className={s.sec}>
          <h2>12. Propriedade intelectual</h2>
          <h3>12.1. Titularidade da Aumigão Walk Tecnologia</h3>
          <p>A Aumigão Walk Tecnologia mantém a titularidade exclusiva sobre toda a propriedade intelectual da Plataforma, incluindo código-fonte, design, algoritmos, bases de dados, documentação e a marca Aumigão Walk. A licença concedida neste Contrato não transfere nem implica cessão de qualquer direito de propriedade intelectual.</p>
          <h3>12.2. Titularidade da Empresa Parceira</h3>
          <p>A Empresa Parceira mantém a titularidade exclusiva sobre sua própria marca, logotipo e identidade visual aplicados à Operação. A Aumigão Walk Tecnologia não adquire qualquer direito sobre a marca da Empresa Parceira pelo uso na Plataforma.</p>
      ...
      <div className={`${s.btnRow} ${s.btnRowCenter}`}>
        ...
        <Link href="/contato" className={`${s.btn} ${s.btnPrimary}`}>Quero ser parceiro →</Link>
      </div>
    </InnerPage>
  );
}
